		...
		if(!o.placeholder || o.placeholder.constructor == String) {
			...
			o.placeholder = {
				...
				update: function(container, p) {
					...
					if(!p.height()) { p.height(self.currentItem.innerHeight() - parseInt(self.currentItem.css('paddingTop')||0, 2) - parseInt(self.currentItem.css('paddingBottom')||0, 2)); };
					if(!p.width()) { p.width(self.currentItem.innerWidth() - parseInt(self.currentItem.css('paddingLeft')||0, 2) - parseInt(self.currentItem.css('paddingRight')||0, 2)); };
				}
			};
		}
