        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" style="padding: 20px;" id="add-field">
            ...
            <div class="col-sm-6">
              ...
              <button class="button grey new-element" data-type="element-year" style="width: 100%;">Year</button>
            ...
            <div class="col-sm-6">
              ...
              <button class="button new-element-slider" data-type="element-checkboxes" style="width: 100%;">Slider</button>
            </div>
