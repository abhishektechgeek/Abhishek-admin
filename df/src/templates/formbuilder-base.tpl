        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" style="padding: 20px;" id="add-field">
            ...
            <div class="col-sm-6">
              ...
              <button class="button grey new-element" data-type="element-section-break" style="width: 100%;">Paragraph</button>
              <button class="button grey new-element" data-type="element-year" style="width: 100%;">Date</button>
              <button class="button grey new-element" data-type="element-year-only" style="width: 100%;">Year</button>
              <button class="button grey new-element-label" data-type="element-label" style="width: 100%;">Text Field [With out Header]</button>
            ...
            <div class="col-sm-6">
              ...
              <button class="button new-element" data-type="element-toggle" style="width: 100%;">Text Field Toggle</button>
              <button class="button new-element-slider" data-type="element-slider" style="width: 100%;">Slider</button>
            </div>
