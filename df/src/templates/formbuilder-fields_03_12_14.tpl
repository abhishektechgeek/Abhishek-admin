        ...
        <ul id="sortable-elements">
          ...
          {#fields}
            ...
            {@eq key="{type}" value="element-label"}
              ...
              <li class="form-element section-break {#required}required{/required}" id="element-{position}" data-label="{title}" data-position="{position}" data-description="{description}" data-type="element-label">
            ...
            {@eq key="{type}" value="element-year"}
              ...
              <li class="form-element section-break {#required}required{/required}" id="element-{position}" data-label="{title}" data-position="{position}" data-description="{description}" data-type="element-year">
