...
<?php
$query2 = $this->db->query("SELECT * FROM `users` WHERE id = '".$edit_data[0]['id']."'");
$row2 = $query2->row();
...
<p class="info" id="info"><span class="info_inner">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</span></p>
    ...
    <div class="portlet">
		...
		<div class="portlet-content nopadding">
         <?php echo form_open('user/save_user',$attributes);?>
         ...
         <div class="form-element">
			...
			if($row3->type == '')
			  $row3->type = 3;?>
             <?php echo form_dropdown('usertype', $user_option, $row3->type);?>
            </span>
		 </div>
         <div class="form-element">
