				...
				<li><a>
					<table width="90%" bgcolor="#ddd" style=" margin: 10px 0px 10px 80px; background-color: #ddd;">
						<tr bgcolor="#ccc">
							...
							<td width="30%"><img src="http://gofavo.com/api/admin/application/uploads/car_was_professional_plus.jpg" width="100px" height="70px"></td>
							<td width="40%">Vehicle</td>
							<td width="20%"><img src="http://gofavo.com/api/admin/layout/images/servicelist/edit.png"></td>
						</tr>
					</table>
				</a>
				</li>
