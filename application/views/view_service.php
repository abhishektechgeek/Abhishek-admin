...
<!-- CONTENT START -->
    ...
    <h1 class="users"> 
	   View service 
        ...
        <a href="<?php echo base_url().'service/servicelistBackButton/'.$segment_id?>" class="edit_inline">Back</a>
    </div>
             ...
             <div class="form-element">
                            ...
                            <span>  
                                ...
                                if ($edit_data[0]['service_type'] > 0) {
                                    ...
                                    echo $serviceType[$edit_data[0]['service_type']];// form_dropdown('service_type', $serviceType, $edit_data[0]['service_type']);
                                } else {
                                   // echo form_dropdown('service_type', $serviceType);
                                    echo $serviceType[$edit_data[0]['service_type']];
                                }
                                ?>
                            </span>
                        </div>       
