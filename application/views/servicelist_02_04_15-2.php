...
<ul>
		...
		<li>
			...
			<table width="300px" height="50px" style="margin-bottom: 0px;border-color:#aaa;border-width:1px;border-style:solid;">
				<tr>
				<td width="20%" bgcolor="#bbb" style="background-color: #bbb;"><center>fgdfg<?php //echo "<img src= $image width= 150px height= 100px />";?></center></td>
				<td width="60%" bgcolor="#bbb" style="background-color: #bbb;"><center>fdgdfgfdg<?php //echo $name; ?> </center></td>
