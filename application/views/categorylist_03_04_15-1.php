...
<p class="info" id="info"><span class="info_inner">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</span></p>
    ...
    <table width="100%" bgcolor="#ddd" style="float: right;  background-color: #ddd;" border="1">
			<tr>
...
<div id="wrapper1" style="  padding-top: 30px !important;">
<div class="tree">
...
'image'=>$key->image,
 'status'=>$key->status
  ...
  //die("dds");
		...
		<li>
		<a> </a>
			<table width="100%" bgcolor="#eee" style="margin-bottom: 10px;  background-color: #eee;">
				<tr>
				<td width="10%"><label>
				...
				<td width="30%"><?php echo "<img src= $img width= 150px height= 100px />";?></td>
				...
				<ul>
                                    <?php foreach ($arr[$row['id']] as $innerRow) { 
                                        //print_r($innerRow);?>
				<li><a>
					<table width="90%" bgcolor="#ddd" style=" margin: 10px 0px 10px 80px; background-color: #ddd;">
						<tr bgcolor="#ccc">
							<td width="10%"><input type="checkbox" value="<?php echo $innerRow['id'];?>" /></td>
                                                        <?php $img ='http://gofavo.com/api/admin/application/uploads/'.$innerRow['image'] ;?>
							<td width="30%"><?php echo "<img src= $img width= 150px height= 100px />";?></td>
							<td width="40%"><?php echo $innerRow['name'];?></td>
							<td width="20%"><?php if($is_modify){
                         ...
                         <a href="<?php echo base_url().'category/edit_segment/'.$innerRow['id'];?>" class="edit_icon" title="Edit"></a> <a href="<?php echo base_url().'category/deletesegment/'.$innerRow['id'];?>" onclick="return confirm('Do you want to delete?');" class="delete_icon" title="Delete"></a></td>
						</tr>
					</table>
				</a>
				</li>
				...
				<li><a>
					<table width="90%" bgcolor="#ddd" style="   margin: 10px 0px 10px 80px; background-color: #ddd;">
						<tr bgcolor="#ccc">
							<td><a href="<?php echo base_url().'category/edit_segment';?>">Add Segment</a></td>
						</tr>
					</table>
				</a>
				</li>
