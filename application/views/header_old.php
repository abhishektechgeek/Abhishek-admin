...
if($seg == 'home')
 ...
 if($seg == 'category' or $seg == 'segment' or $seg == 'service')
  $category1 = 'current';
else 
 $category1 = '';
...
<?php //echo $user_detail[0]->id; 
 	...
 	$query2 = $this->db->query("SELECT menus FROM `admin`  WHERE id = '".$user_detail[0]->id."'");
	$row2 = $query2->result_array();
 	 if($row2[0]['menus']){ 
	 $query3 = $this->db->query("SELECT title FROM `menu`  WHERE menu_id IN (".$row2[0]['menus'].")");
	...
	if($value['title'] == 'Dashboard'){
	  ...
	  if($value['title'] == 'Users'){
	  ?>
	 <li class="item middle" id="four"><a href="<?php echo base_url().'user/userlist';?>" class="main <?php echo $user;?>"><span class="outer"><span class="inner users">Users</span></span></a></li>
      
      <?php }  
	
	 if($value['title'] == 'Service Plans'){
	  ?>
	 <li class="item middle" id="eight"><a href="<?php echo base_url().'serviceplan/';?>" class="main <?php echo $serviceplan;?>"><span class="outer"><span class="inner event_manager">Service Plans</span></span></a></li>
      
      <?php } 
	  
	  if($value['title'] == 'Skills'){
	  ?>
	<li class="item middle" id="eight"><a href="<?php echo base_url().'category/';?>" class="main <?php echo $category1;?>"><span class="outer"><span class="inner skills">Skills</span></span></a></li>  
	  ...
	  if($value['title'] == 'Admins'){
	  ?>
	<li class="item last" id="eight"><a href="<?php echo base_url().'admins/';?>" class="main <?php echo $admins;?>"><span class="outer"><span class="inner skills">Admins</span></span></a></li>
