    ...
    <div id="portlets">
        ...
        <div class="portlet" >
            ...
            <div class="portlet-content nopadding">
                ...
                <?php echo form_open_multipart('serviceupgrade/save_serviceupgrade', $attributes); ?>
                <div class="form-element" >
                    ...
                    <div id="tabs-1">
                        <div class="form-element">
                            <span id="text_name">service upgrade name</span>
                        ...
                        <div class="form-element">
                            ...
                            <span id="text_name"> : </span>
                            <span>
                                <textarea name="description" id="description" rows="4" cols="30" ><?php
                                if ($edit_data[0]['id'] > 0) {
