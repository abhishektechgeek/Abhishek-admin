				...
				<li><a>
					<table width="650px" style="margin:10px 0px 18px 180px;">
						<tr>
                         ...
                         <a href="<?php echo base_url().'segment/edit_segment/'.$innerRow['id'];?>" class="edit_icon" title="Edit"></a> <a href="<?php echo base_url().'segment/deletesegment/'.$row->id;?>" onclick="return confirm('Do you want to delete?');" class="delete_icon" title="Delete"></a></td>
			<td width="10%"><font color="#ddd">------------</font></td>
       <td width="20%"  style="background: #eee;"><a href="<?php echo base_url().'service/servicelist/'.$innerRow['id']?>">Add/Edit Services</a></td>
