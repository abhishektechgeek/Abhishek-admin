...
<ul>
		...
		<li>
			...
			<table width="300px" height="50px" style="margin-bottom: 0px;border-color:#aaa;border-width:1px;border-style:solid;">
				<tr>
				<td width="20%" bgcolor="#bbb" style="background-color: #bbb;"><center><?php echo "<img src= $image width= 80px height= 80px />";?></center></td>
				<td width="60%" bgcolor="#bbb" style="background-color: #bbb;"><center><?php echo $name; ?> </center></td>
				<td width="20%" bgcolor="#bbb" style="background-color: #bbb;"><center>
                                    <!--<?php if($is_modify){
                                                           // echo"aaaa".$innerRow['status'];
                         ...
                         <a href="<?php echo base_url().'segment/edit_segment/'.$row->id;?>" class="edit_icon" title="Edit"></a> <a href="<?php echo base_url().'segment/deletesegment/'.$row->id;?>" onclick="return confirm('Do you want to delete?');" class="delete_icon" title="Delete"></a></center> --></td>
				</tr>
			</table>
                                <?php }?>
			<a></a>
					...
					<li>
							<table  id="details">
								<tr>
									...
									<td width="64px"><div style="word-wrap: break-word;width:64px;"><?php echo $row->name ; ?>   </div></td>
									...
									<td width="30px"><div style="word-wrap: break-word;width:30px;">.</div></td>
									<td width="62px"><div style="word-wrap: break-word;width:62px;"><?php
        ...
        ?></div></td>
									<td width="53px"><div style="word-wrap: break-word;width:53px;"><?php
        ...
        ?></div></td>
									<td width="57px"><div style="word-wrap: break-word;width:57px;"><a href="#"><a href="<?php echo base_url().'serviceupgrade/index/'.$row->id.'/'.$segId;?>"  title="Add Sub Service">Service Upgrade</a></a></div></td>
									<td width="57px"><div style="word-wrap: break-word;width:57px;"><a href="<?php echo base_url().'service/customerFormList/'.$row->id.'/'.$segId;?>"  title="Customer">Customer</a></div></td>
									...
									<td width="38px"><div style="word-wrap: break-word;width:38px;"><a href="<?php echo base_url().'service/view_service/'.$row->id.'/'.$segId;?>"  title="View">View</a></div></td>
								</tr>
              ...
              ?>
				...
				<li><a>
					<table width="800px" bgcolor="#ddd" style="margin: 10px 0px 10px 103px;background:#ddd">
						<tr bgcolor="#ccc" >
							<td style="padding:5px;background:#ddd"><?php if($is_modify){?><a href="<?php echo base_url().'service/edit_service'?>" class="edit_inline">Add New</a><?php }?></td>
						</tr>
					</table>
				</a>
