    ...
    <div id="portlets">
        ...
        <div class="portlet" >
            ...
            <div class="portlet-content nopadding">
                ...
                <?php echo form_open_multipart('service/save_service_image', $attributes); ?>
                <div class="form-element" >
                 ...
                 <!-- <a href='<?php echo base_url()."service/service_upgrade/".$edit_data[0]['id']; ?>'>service Upgrade </a> -->
                    ...
                    <div id="tabs-1">
                        ...
                        <?php echo form_hidden('name', $edit_data[0]['name']);  ?>
                        <?php echo form_hidden('description', $edit_data[0]['description']);  ?>
