...
<ul>
        ...
        ?></div></td>
									...
									<td width="51px"><div style="word-wrap: break-word;width:51px;"><a href="#"  style="  float: left;" onclick="window.open('<?php echo base_url().'service/edit_service/'.$row->id.'/'.$segment_id?>','mywindow','width=700,height=400  top=200, left=200');">edit</a></div></td>
