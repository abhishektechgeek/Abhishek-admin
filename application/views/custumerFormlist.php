...
//var url ='http://gofavo.com/api/admin/df/exist.php?skill_id='+id;
   $("#target").attr("action", "javascript:var w=window.open('http://gofavo.com/api/admin/df/exist.php?skill_id="+id+"&edit_id="+<?php echo $edit_id ; ?>+"', '_blank', 'width=900,height=400, top=100px , left=100px , menubar=no ,titlebar=no,toolbar=no');");
   $( "#target" ).submit();
}
