...
<p class="info" id="info"><span class="info_inner">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</span></p>
    ...
    <div class="portlet">
        ...
        ?></td>
                        ...
                        <td> <a href="<?php echo base_url().'serviceupgrade/index/'.$row->id;?>"  title="Add Sub Service">Service Upgrade</a></td>
                        <td> <a href="<?php echo base_url().'service/customerFormList/'.$row->id;?>"  title="Customer">Customer Details</a></td>
