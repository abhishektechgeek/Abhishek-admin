   ...
   //alert('bbbb');
     ...
     // alert(timeInterval);
      ...
      $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>servicetimeslot/update_service_type/"+id+"/"+val , 
...
<ul>
		...
		<li>
			...
			<a></a>
				...
				<table id="details-head" width="">
											...
											<td rowspan=2 width="50px">Delete</td>
											</tr>
					...
					<li id="arrayorder_<?php echo $row->id ?>">
							<table  id="details">
								...
								<tr>
									...
									<td width="76px"><div style="word-wrap: break-word;width:76px;"> <a href="#"  style="  float: left;" onclick="window.open('<?php echo base_url().'service/edit_service/'.$row->id.'/'.$segment_id?>','mywindow','width=700,height=400  top=200, left=200');">edit</a> </div></td>
									...
									<td width="130px"><div style="word-wrap: break-word;width:130px;"><a href="#" onclick="window.open('<?php echo $imageService ?>','mywindow','width=400,height=300  top=200, left=200')">Image <a href="#"  style="  float: left;" onclick="window.open('<?php echo base_url().'service/edit_service_image/'.$row->id.'/'.$segment_id?>','mywindow','width=700,height=400  top=200, left=200');">edit</a> </a> </div></td>
        ...
        ?></div></td>
									...
									<td width="75px"><div style="word-wrap: break-word;width:51px;"> 
                              

                                <?php //echo $row->service_type;
                               // if ($row->service_type > 0) {

                                    echo form_dropdown('service_type', $serviceType, $row->service_type ,'class="service_type_dp"  id="'.$id.'"');
                                //} else {
                                 //   echo form_dropdown('service_type', $serviceType ,'class="service_type_dp"  id="'.$id.'"');
                              //  }
                                ?>
									...
									<td width="50px"><div style="word-wrap: break-word;width:50px;"><a href="<?php echo base_url().'service/deleteservice/'.$row->id.'/'.$segment_id;?>" onclick="return confirm('Do you want to delete?');" class="delete_icon" title="Delete"></a></div></td>
								</tr>
