   ...
   // alert(this.id);
    ...
    //  alert(time);
      ...
      $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>servicetimeslot/update_time_slot/"+id+"/"+time , 
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
     <h1 class="skills">Service Time Slot</h1>
    </div>
...
<p class="info" id="info"><span class="info_inner">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</span></p>
    ...
    <div class="portlet">
        ...
        <?php  if($is_modify){?><a href="<?php echo base_url().'servicetimeslot/edit_servicetimeslot'?>" class="edit_inline">Add New</a><?php }?> 
        </div>
       -->
        ...
        <form action="<?php echo base_url().'service/all_service'?>" method="post">
          <table width="100%" cellpadding="0" cellspacing="0" summary="Employee Pay Sheet" id="sample_1">
            <thead>
              <tr>
                <th width="10%" scope="col"><input type="checkbox" name="allbox" id="allbox" onclick="checkAll()" /></th>
                <th width="70%" scope="col">service Name</th>
                <th width="25%" scope="col">Time Slot</th>
            ...
            echo form_dropdown('dropdown_name', $options, $row->timeslot, 'class="dropdown_class"  id='.$id);
...
<script src="<?php echo base_url(); ?>/assets/scripts/jquery-1.8.3.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>/assets/scripts/jquery.dataTables.js"></script>
   <script type="text/javascript" src="<?php echo base_url(); ?>/assets/scripts/DT_bootstrap.js"></script>
   <script src="<?php echo base_url(); ?>/assets/scripts/dynamic-table.js"></script>
