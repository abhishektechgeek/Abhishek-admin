...
<ul>
        ...
        ?></div></td>
									<td width="74px"><div style="word-wrap: break-word;width:74px;"><a href="#"><a href="<?php echo base_url().'serviceupgrade/index/'.$row->id.'/'.$segId;?>"  title="Add Sub Service">Service Upgrade</a></a></div></td>
									...
									<td width="51px"><div style="word-wrap: break-word;width:51px;"><a href="<?php echo base_url().'service/edit_service/'.$row->id.'/'.$segId;?>"  title="View">edit</a></div></td>
              ...
              ?>
				...
				<li><a>
					<table width="1085px" bgcolor="#ddd" style="margin: 10px 0px 10px 103px;background:#ddd">
						<tr bgcolor="#ccc" >
							<td  style="padding:5px;background:#ddd"> <?php if($is_modify){?><a href="#" class="edit_inline" style="  float: left;" onclick="window.open('<?php echo base_url().'service/edit_service'?>','mywindow','width=700,height=400  top=200, left=200');">Add New</a><?php }?></td>
						</tr>
					</table>
				</a>
