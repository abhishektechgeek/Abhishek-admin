					...
					<li id="arrayorder_<?php echo $row->id ?>">
							<table  id="details">
								...
								<tr>
									...
									<td width="76px"><div style="word-wrap: break-word;width:76px;"> <a href="#"  style="  float: left;" onclick="window.open('<?php echo base_url().'service/edit_service/'.$row->id.'/'.$segment_id?>','mywindow','width=700,height=400  top=200, left=200');">edit</a> <a href="<?php echo base_url().'service/deleteservice/'.$row->id.'/'.$segment_id;?>" onclick="return confirm('Do you want to delete?');" class="delete_icon" title="Delete"></a></div></td>
