...
<ul>
					...
					<li id="arrayorder_<?php echo $row->id ?>">
							<table  id="details">
								<tr>
									...
									<td width="80px"><div style="word-wrap: break-word;width:80px;">.</div></td>
									<td width="40px"><div style="word-wrap: break-word;width:40px;">.</div></td>
									<td width="130px"><div style="word-wrap: break-word;width:130px;">.</div></td>
        ...
        ?></div></td>
									...
									<td width="51px"><div style="word-wrap: break-word;width:51px;"><a href="#">edit</a></div></td>
              ...
              ?>
				...
				<li><a>
					<table width="1085px" bgcolor="#ddd" style="margin: 10px 0px 10px 103px;background:#ddd">
						<tr bgcolor="#ccc" >
							<td style="padding:5px;background:#ddd"><?php if($is_modify){?><a style="  float: left;" href="<?php echo base_url().'service/edit_service'?>" class="edit_inline">Add New</a><?php }?></td>
						</tr>
					</table>
				</a>
